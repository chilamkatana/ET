...
namespace ET.Client
{
    ...
    public static partial class LoginViewComponentSystem
    {
        ...
        private static void UIBind(this LoginViewComponent self)
        {
            ...
            self.u_ComAccount = self.UIBase.ComponentTable.FindComponent<TMPro.TMP_InputField>("u_ComAccount");
            self.u_ComPassWord = self.UIBase.ComponentTable.FindComponent<TMPro.TMP_InputField>("u_ComPassWord");
            ...
            self.u_EventLoginSignUp = self.UIBase.EventTable.FindEvent<UITaskEventP0>("u_EventLoginSignUp");
            self.u_EventLoginSignUpHandle = self.u_EventLoginSignUp.Add(self,LoginViewComponent.OnEventLoginSignUpInvoke);
