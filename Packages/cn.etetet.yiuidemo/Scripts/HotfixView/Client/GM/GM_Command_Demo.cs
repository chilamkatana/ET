...
namespace ET.Client
{
    ...
    [GM(EGMType.Demo, 1, "Demo案列", "Demo案列描述.....")]
    public class GM_Demo : IGMCommand
    {
        public List<GMParamInfo> GetParams()
        {
            return new()
            {
                new GMParamInfo(EGMParamType.Int, "参数1 整数", "999"),
                
                new GMParamInfo(EGMParamType.Enum, "参数2 枚举", "ShopGemView", "ET.Client.EShopPanelViewEnum"),
        ...
        {
            var param1 = paramVo.Get<int>(0);
            var param2 = paramVo.Get<EShopPanelViewEnum>(1);
            
            YIUIMgrComponent.Inst.Root.OpenPanelAsync<ShopPanelComponent, EShopPanelViewEnum>(param2).NoContext();
