...
namespace ET
{
    ...
    public static partial class NumericDataExtend
    {
        ...
        /// 确定你了解原生值
        /// </summary>
        public static long GetRealValue(this NumericData self, int numericType)
        {
            return self.GetByKey(numericType);
        }

        public static long GetRealValue(this NumericData self, ENumericType numericType)
        {
            return self.GetRealValue((int)numericType);
        }
        ...
        public static object GetObjectValue(this NumericData self, int numeric)
        {
            return self.GetObjectValue((ENumericType)numeric);
        }
