...
namespace ET
{
    ...
    public static partial class NumericDataComponentSystem
    {
        ...
        public static long GetRealValue(this NumericDataComponent self, int numericType)
        {
            return self.NumericData.GetRealValue(numericType);
        }

        public static long GetRealValue(this NumericDataComponent self, ENumericType numericType)
        {
            return self.NumericData.GetRealValue(numericType);
        }

        public static object GetObjectValue(this NumericDataComponent self, int numericType)
        {
